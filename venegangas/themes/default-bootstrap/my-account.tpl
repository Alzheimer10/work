...
<div class="row addresses-lists">
	<div class="col-xs-12 col-sm-6 col-lg-4">
		<ul class="myaccount-link-list">
            ...
            <li class="nuevo"><a href="{$link->getPageLink('registromercadolibre', true)|escape:'html':'UTF-8'}" title="{l s='Information'}"><i class="icon-exchange"></i><span>Registro de pago mercadolibre</span></a></li>  
            <style type="text/css">
            ...
            <li><a href="{$link->getPageLink('registropago', true)|escape:'html':'UTF-8'}" title="{l s='Information'}"><i class="icon-check"></i><span>{l s='Registrar Pagos'}</span></a></li>  
        </ul>
	</div>
